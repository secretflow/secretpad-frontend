...
const checkFeaturesIsEqual = (
  variableBins: ParametersData['variableParametersData'],
  testData: ParametersData['variableParametersData'],
) => {
...
export const UploadBinning = () => {
  const { parametersData, setCurrOperation, setBinningData, disabled } = useModel(
    ...
    reader.onload = () => {
      ...
      if (data && parametersData) {
        const isEqual = checkFeaturesIsEqual(
          parametersData.variableParametersData,
          data.variableBins,
        );
